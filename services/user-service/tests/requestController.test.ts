...
describe('RequestController', () => {
  ...
  describe('getDemoteRequests', () => {
    it('should return pending demote requests', async () => {
      const mockData = [{ id: 1, status: 'pending' }];
      mockFrom.mockReturnValue({
        select: vi.fn().mockReturnValue({
          eq: vi.fn().mockReturnValue({
      ...
      const req = {} as Request;
      const res = mockRes();
      await RequestController.getDemoteRequests(req, res);
      expect(res.json).toHaveBeenCalledWith(mockData);
    });
  ...
  describe('requestDemote', () => {
    it('should create demote request successfully', async () => {
      const req = { params: { id: 'user123' } } as unknown as Request;
      const res = mockRes();
      mockFrom
        .mockReturnValueOnce({
      ...
      await RequestController.requestDemote(req, res);
      expect(res.status).toHaveBeenCalledWith(201);
      expect(res.json).toHaveBeenCalledWith({ success: true });
    });
    ...
    it('should return 400 if already requested', async () => {
      ...
      await RequestController.requestDemote(req, res);
      expect(res.status).toHaveBeenCalledWith(400);
      expect(res.json).toHaveBeenCalledWith({ error: 'Already requested demote' });
    });
  ...
  describe('approveDemote', () => {
    it('should approve demote request successfully', async () => {
      const req = { params: { id: 'request123' } } as unknown as Request;
      const res = mockRes();
      mockFrom
        .mockReturnValueOnce({
      ...
      await RequestController.approveDemote(req, res);
      expect(res.status).toHaveBeenCalledWith(200);
      expect(res.json).toHaveBeenCalledWith({ success: true });
    });
  ...
  describe('rejectDemote', () => {
    it('should reject demote request successfully', async () => {
      const req = { params: { id: 'request123' } } as unknown as Request;
      const res = mockRes();
      mockFrom
        .mockReturnValueOnce({
      ...
      await RequestController.rejectDemote(req, res);
      expect(res.status).toHaveBeenCalledWith(200);
      expect(res.json).toHaveBeenCalledWith({ success: true });
    });
